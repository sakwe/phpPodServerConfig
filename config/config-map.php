...
Structure of the configuration datas in "$podserver_config_map" array : 
	...
	2- group : name of the group of datas (tabs)
		you can add a new group that will render a new tab with your items into 
	...
	3- depend : put the name of the item from witch the accessibility depends
		accessible on check box or select state (enable or not, value selected or value none)		
	...
	5- value : will receive the correct value from the config file. Here you can put the default value
...
$podserver_config_map = array
	...
	array('dyndns_login','network','none','text','',''),
	array('dyndns_pass','network','none','password','',''),
	...
	array('mail_enable','mail','none','text','',''),
	...
	array('smtp_login','mail','mail_enable','text','',''),
	array('smtp_pass','mail','mail_enable','password','',''),
	...
	array('title_password_change','administration','none','title','',''),
	array('pass1','administration','none','text','',''),
	array('pass2','administration','none','text','',''),
