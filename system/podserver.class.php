...
include($_SERVER['DOCUMENT_ROOT'].'/config/podserver_map.php'); 

// include configuration and dispatch classes needed by PodServer class
include($_SERVER['DOCUMENT_ROOT'].'/system/podserver_configuration.class.php'); 
include($_SERVER['DOCUMENT_ROOT'].'/system/podserver_system.class.php'); 
include($_SERVER['DOCUMENT_ROOT'].'/system/podserver_dispatcher.class.php'); 
...
class PodServer {
	...
	public function getForm($content,$action="") {
		...
		$form.= '</div><script>'."\n".'
			...
			<script src="http://'.$_SERVER['HTTP_HOST']. '/js/podserver_interface.js" type="text/javascript"></script>'."\n";
	...
	public function getTitle(){
		return '<div class="header_bar">'.BIG_TITLE_POD_CONFIGURATION.'<a href="#" class="show_hide" title="'.SHOW_HIDE_TERMINAL.'"><img src="images/gnome-terminal.png" /></a></div>';
	}
